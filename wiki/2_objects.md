...
- **Cores**: Your team's central hub. When yours is destroyed, you lose, when you destroy your opponents, you win. Also used to spawn new units if it has enough gems stored. And it is the namesake of CORE GAME. There will only ever be one core per team.
