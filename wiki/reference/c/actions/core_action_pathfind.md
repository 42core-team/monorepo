...
https://github.com/42core-team/monorepo/blob/dev/bots/c/client_lib/src/public/actions.c#L41
...
It is encouraged that you write your own pathfinder eventually for a good bot using [`core_action_move`](reference/c/actions/core_action_move) and [`core_action_attack`](reference/c/actions/core_action_attack), this function is just a util for you to easily get started.
